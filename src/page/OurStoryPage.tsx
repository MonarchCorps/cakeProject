...
export const OurStoryPage = () => {
    return (
            <>
                ...
                />
                <div className={"h-[923px] bg-[#A7C7E7] z-20 w-full"}>
                    <div className={"flex h-full justify-around items-center w-full"}>
                        <div className={"w-[400px] h-[582px]"}>
                        <img src={Founder} className={"w-full h-full object-cover object-top"} alt={"Founder"} />
                        </div>
                        <div className={"flex flex-col gap-5 w-[654px]"}>
                        <p className={"capitalize font-bold text-2xl text-[#0F4C81]"}>How the Founder got here</p>
                            <p className={"font-[500] text-white text-xl leading-tight"}>
                ...
                <div className={"h-[833px] z-20 w-full"}>
                    <div className={"flex h-full justify-around items-center w-full"}>
